...
/**
 * Self-test: a `#[RunInCoroutine]` test runs as a coroutine on the Revolt event loop — it executes
 * inside a fiber and can await real async work (a timer) and resume without blocking the process.
 */
#[Test]
#[RunInCoroutine]
