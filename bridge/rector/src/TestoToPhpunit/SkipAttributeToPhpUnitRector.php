...
final class SkipAttributeToPhpUnitRector extends AbstractRector
{
    ...
    /**
     * The first attribute named $name on the method, removed from it; null when the method carries
     * none. Removing it here is what keeps the emitted call the only trace of the skip.
     */
    ...
    /**
     * The methods a skip can apply to, mirroring Testo discovery: the `#[Test]`-marked methods when
     * any exist (Testo's or the converted PHPUnit form), otherwise — under a class-level
     * `#[\Testo\Test]` — every public, non-static, void/never, non-lifecycle method.
     *
