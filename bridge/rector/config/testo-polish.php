 ...
 *
 * Scope it to the test directories: the return-type rules apply to any method in the paths. Run it
 * as its own pass once the suite is green on Testo, so the class-level rules see the `#[Test]`
 * attributes the conversion set has already placed.
 */
