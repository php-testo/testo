 ...
 *
 * Each fiber sees its own value; the main (no-fiber) thread has its own slot too. Reading from one fiber
 * never observes what another fiber stored, so concurrently running fibers stay isolated with no manual
